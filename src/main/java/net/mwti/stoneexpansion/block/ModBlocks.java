...
public class ModBlocks {
    ...
    public static void registerModBlocks(){
        ...
        registerBlock(COBBLED, ANDESITE, new Block(FabricBlockSettings.copyOf(Blocks.ANDESITE)));
        ...
        registerBlock(COBBLED, GRANITE, new Block(FabricBlockSettings.copyOf(Blocks.GRANITE)));
        ...
        registerBlock(COBBLED, DIORITE, new Block(FabricBlockSettings.copyOf(Blocks.DIORITE)));
        ...
        addBlockToTable(COBBLED, STONE, BLOCK, Blocks.COBBLESTONE);
        addBlockToTable(COBBLED, STONE, STAIRS, Blocks.COBBLESTONE_STAIRS);
        addBlockToTable(COBBLED, STONE, SLAB, Blocks.COBBLESTONE_SLAB);
        addBlockToTable(COBBLED, STONE, WALL, Blocks.COBBLESTONE_WALL);
        ...
        addBlockToTable(COBBLED, MOSSY_STONE, BLOCK, Blocks.MOSSY_COBBLESTONE);
        addBlockToTable(COBBLED, MOSSY_STONE, STAIRS, Blocks.MOSSY_COBBLESTONE_STAIRS);
        addBlockToTable(COBBLED, MOSSY_STONE, SLAB, Blocks.MOSSY_COBBLESTONE_SLAB);
        addBlockToTable(COBBLED, MOSSY_STONE, WALL, Blocks.MOSSY_COBBLESTONE_WALL);
        ...
        registerBlock(COBBLED, END_STONE, new Block(FabricBlockSettings.copyOf(Blocks.END_STONE)));
        ...
        registerBlock(COBBLED, PURPUR, new Block(FabricBlockSettings.copyOf(Blocks.PURPUR_BLOCK)));
        ...
        registerBlock(COBBLED, SANDSTONE, new Block(FabricBlockSettings.copyOf(Blocks.SANDSTONE)));
        ...
        registerBlock(COBBLED, RED_SANDSTONE, new Block(FabricBlockSettings.copyOf(Blocks.RED_SANDSTONE)));
        ...
        addBlockToTable(BASE, DEEPSLATE, BLOCK, Blocks.DEEPSLATE);
        addBlockToTable(COBBLED, DEEPSLATE, BLOCK, Blocks.COBBLED_DEEPSLATE);
        addBlockToTable(COBBLED, DEEPSLATE, SLAB, Blocks.COBBLED_DEEPSLATE_SLAB);
        addBlockToTable(COBBLED, DEEPSLATE, STAIRS, Blocks.COBBLED_DEEPSLATE_STAIRS);
        addBlockToTable(COBBLED, DEEPSLATE, WALL, Blocks.COBBLED_DEEPSLATE_WALL);
        ...
        registerBlock(COBBLED, BLACKSTONE, new Block(FabricBlockSettings.copyOf(Blocks.BLACKSTONE)));
        ...
        registerBlock(COBBLED, MUD, new Block(FabricBlockSettings.copyOf(Blocks.PACKED_MUD)));
        ...
        registerBlock(COBBLED, BRICKS, new Block(FabricBlockSettings.copyOf(Blocks.BRICKS)));
        ...
        //addBlockToTable(BASE,NETHER_BRICKS, Blocks.NETHER_BRICKS); /// already exists as bricks
        registerBlock(COBBLED, NETHER_BRICKS, new Block(FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS)));
        ...
        registerBlock(COBBLED, QUARTZ, new Block(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK)));
        ...
        registerBlock(COBBLED, PRISMARINE, new Block(FabricBlockSettings.copyOf(Blocks.PRISMARINE)));
        ...
        registerBlock(COBBLED, BASALT, new Block(FabricBlockSettings.copyOf(Blocks.BASALT)));
